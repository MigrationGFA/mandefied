...
import { L as Landmark, c as MapPin, i as Earth, j as HandCoins, G as GraduationCap, k as HeartPulse, l as Wheat, m as HardHat, n as Leaf, o as ChartColumn, H as Heart, p as Lightbulb } from "../_libs/lucide-react.mjs";
const cases = [
  {
    icon: Landmark,
...
function UseCases() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionHeading,
      {
        ...
        title: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          "Mandefied adapts to ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient-warm", children: "your workflow" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-16 grid sm:grid-cols-2 lg:grid-cols-3 gap-5", children: cases.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(c.icon, { className: "h-6 w-6", strokeWidth: 2 })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-5 text-lg font-semibold text-foreground", children: c.title }),
