      ...
      <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        <div className="order-2 lg:order-1 relative">
          ...
          <div className="relative rounded-2xl border border-border bg-card shadow-elegant overflow-hidden">
            <div className="flex items-center justify-between px-5 py-3 border-b border-border bg-surface">
              ...
              <span className="text-[10px] font-mono uppercase text-muted-foreground">Auto-generated</span>
            </div>
        ...
        <div className="order-1 lg:order-2">
          ...
          <h2 className="mt-5 text-3xl md:text-5xl font-semibold tracking-tight">
            From raw data to <span className="text-gradient-primary">funder-ready reports</span> in minutes.
          </h2>
          <p className="mt-5 text-lg text-muted-foreground leading-relaxed">
            Mandefied generates monthly, quarterly, and annual reports automatically —
            in the exact templates your funders expect.
          </p>
